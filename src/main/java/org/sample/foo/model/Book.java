...
public record Book(String id, String name, int pageCount, String authorId) {
	...
	private static Map<String, Book> idTobook = Map.of(
			"book-1", new Book("book-1", "Effective Java", 416, "author-1"),
			"book-2", new Book("book-2", "Hitchhiker's Guide to the Galaxy", 208, "author-2"),
			"book-3", new Book("book-3", "Down Under", 436, "author-3"));
